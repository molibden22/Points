...
MainWindow::MainWindow(QWidget *parent)
    : QWidget(parent), interactivePointsTable(new InteractivePointsTable(this)), userController(new UserController(this)) {
    QRect rectangle(400,300,800,600);
    setGeometry(rectangle);
    //setStyleSheet("background-color: rgb(100, 100, 100)");

    QPalette paleta(QColor(230,230,230), QColor(60,60,60), QColor(160,160,160),
             QColor(40,40,40), QColor(80,80,80), QColor(30,30,30), QColor(120,120,120));
